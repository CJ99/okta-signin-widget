...
import idpForceResponseLinkedInIdP from '../../../../playground/mocks/data/api/v1/authn/forced-idp-discovery-linkedin-idp.json';
import idpForceResponseOktaIdP from '../../../../playground/mocks/data/api/v1/authn/forced-idp-discovery-okta-idp.json';
...
const legacyDeviceCodeIdpCheckWithRedirectionMock = RequestMock()
  ...
  .onRequestTo('http://localhost:3000/.well-known/webfinger?resource=okta%3Aacct%3Aundefined&requestContext=aStateToken')
  .respond(idpForceResponseLinkedInIdP)
  .onRequestTo('http://localhost:3000/sso/idps/0oa4onxsxfUDwUb8u0g4?stateToken=00CazfnZW7EeVlIJoByKsUAdvMEcBvnN39We9ji5QL&login_hint=undefined#')
...
test.requestHooks(requestLogger, legacyDeviceCodeIdpCheckWithRedirectionMock)('force idp discovery after device activate and redirect to idp', async t => {
  ...
  await t.expect(pageUrl)
    .eql('http://localhost:3000/sso/idps/0oa4onxsxfUDwUb8u0g4?stateToken=00CazfnZW7EeVlIJoByKsUAdvMEcBvnN39We9ji5QL&login_hint=undefined#');
});
